...
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad10b_antes-saliamos-con-los-amigos.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 10B | 49 | **solucionario oficial** (página 61 del propio cuaderno). El ejercicio 1 del libro es un «relaciona» (columna de frases en pretérito imperfecto con su continuación), archivado con el motor `type:"match"`. Sin ejercicios de audio |
