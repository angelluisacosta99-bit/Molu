...
| `nuevo-espanol-en-marcha/b1/cuaderno-unidad8a_deportes.md` | Nuevo Español en Marcha 3 (B1), **cuaderno de ejercicios**, unidad 8A | 32 | **solucionario oficial** (página 72). El ej. 1 es una sopa de letras **interactiva de verdad** (`type: "wordsearch"`) con una rejilla propia, verificada por script en las 8 direcciones; lleva además la ilustración real de los objetos deportivos recortada de la página 32 (no un nombre de texto como pista — el profesor pidió expresamente la foto real en vez de "regalar" la respuesta). La pregunta del libro sobre el deporte de cada objeto no se formaliza en huecos propios (el libro tampoco la da como ejercicio numerado, es una pregunta abierta de apoyo a la imagen). El ej. 3 es de audio (pista 11, entrevista al ciclista Emilio Pedal) y lleva la grabación real más su transcripción completa (página 65-66) |
