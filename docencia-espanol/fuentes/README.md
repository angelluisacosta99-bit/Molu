...
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad1a_encantado.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 1A | 4-5 | **solucionario oficial** (página 56 del propio cuaderno). El ej. 1 es un «relaciona» genuino construido con `type:"match"` y columna barajada. El ej. 6 (deletrear apellidos/ciudades) se archiva como lista de dictados con la respuesta ya deducida de las letras. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad1b_a-que-te-dedicas.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 1B | 5-6 | **solucionario oficial** (página 56 del propio cuaderno). El ej. 1 (sopa de letras de ocho profesiones, ilustradas con dibujos en el libro) se archiva como lista de pistas de dos letras. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad1c_cual-es-tu-numero-de-movil.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 1C | 6-7 | **solucionario oficial** (página 56 del propio cuaderno). El ej. 1 es un «relaciona» genuino (números de teléfono con su transcripción en letras), construido con `type:"match"` y columna barajada. El ej. 4 es de audio (pista 1) y lleva su transcripción, tomada de la página 54 |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad2a_estas-casado.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 2A | 8 | **solucionario oficial** (página 56 del propio cuaderno). El ej. 1 es un «relaciona» genuino (preguntas/respuestas sobre la familia) construido con `type:"match"` y columna barajada por desplazamiento de 4 posiciones sobre 10 filas. El ej. 3 usa el árbol genealógico del libro, transcrito como texto de referencia en vez de dibujar el árbol. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad2b_donde-estan-mis-gafas.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 2B | 9-10 | **solucionario oficial** (página 56 del propio cuaderno). El ej. 1 (sopa de letras de 11 objetos ilustrados con dibujos en el libro) se archiva como lista de pistas de dos letras. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad2c_que-hora-es.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 2C | 10-11 | **solucionario oficial** (página 57 del propio cuaderno). Dos ejercicios de audio (pistas 2 y 3) llevan su transcripción, tomada de la página 54. El ej. 5 usa el texto de lectura «Hijos adoptados» como referencia para las preguntas V/F, con `vf` |
| `nuevo-espanol-en-marcha/a1/practica-mas-1_unidades-1-2.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, «Practica más 1» (repaso de las unidades 1 y 2) | 12-13 | **solucionario oficial** (página 57 del propio cuaderno). El ej. 1 usa `type:"conjTable"` (celdas ya resueltas por el libro fijas, el resto huecos). El ej. 4 (clasificar masculino/femenino) usa `vf` con un par de botones personalizado `["M","F"]`. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad3a_rosa-se-levanta-a-las-siete.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 3A | 14-15 | **solucionario oficial** (página 57 del propio cuaderno). El ej. 3 es un «relaciona» genuino (verbos opuestos/relacionados) construido con `type:"match"` y columna barajada. El ej. 5 (sopa de letras de formas verbales) se archiva como lista de pistas. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad3b_estudias-o-trabajas.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 3B | 15-16 | **solucionario oficial** (página 57 del propio cuaderno). Los ej. 2 y 3 son «relaciona» genuinos construidos con `type:"match"`; el ej. 2 sustituye las siete fotos por su descripción textual. El ej. 1 (fichas con sílabas que forman los días de la semana) pide directamente el día resultante. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad3c_que-desayunas.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 3C | 17 | **solucionario oficial** (página 57 del propio cuaderno). El ej. 1 es de audio (pista 4) y lleva su transcripción, tomada de la página 54. El ej. 2 dice explícitamente «hay más de una posibilidad» — se archiva como `type:"open"` con las respuestas de referencia. El ej. 3 es de respuesta libre |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad4a_donde-vives.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 4A | 18 | **solucionario oficial** (página 58 del propio cuaderno). El ej. 1 sustituye las siete fotos de muebles/objetos por su descripción textual. El ej. 3 usa el anuncio «Venta de pisos» como referencia. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad4b_interiores.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 4B | 19-20 | **solucionario oficial** (página 58 del propio cuaderno). El ej. 7 es de audio (pista 5) y lleva su transcripción, tomada de la página 54-55; usa `vf` con ámbito por hueco (`vf:{0:["V","F"]}`) para separar el botón V/F de la corrección en texto libre |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad4c_visita-a-cordoba.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 4C | 21 | **solucionario oficial** (página 58 del propio cuaderno). El ej. 3 usa el correo de María como referencia. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/practica-mas-2_unidades-3-4.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, «Practica más 2» (repaso de las unidades 3 y 4) | 22-23 | **solucionario oficial** (página 58 del propio cuaderno). Los ej. 1 y 6 son «relaciona» genuinos construidos con `type:"match"`. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad5a_comer-fuera-de-casa.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 5A | 24 | **solucionario oficial** (página 58 del propio cuaderno). El ej. 1 sustituye los dibujos de comida por su descripción textual. El ej. 3 combina el «ordena las frases» con completar el diálogo del restaurante en el mismo ejercicio. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad5b_te-gusta-el-cine.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 5B | 25-26 | **solucionario oficial** (página 58 del propio cuaderno). El ej. 1 sustituye los dibujos de las habitaciones de Carmen y Pablo por su descripción textual. Los ej. 2 y 5 son de respuesta libre («Actividad libre» en el solucionario). Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a1/cuaderno-unidad5c_receta-del-caribe.md` | Nuevo Español en Marcha 1 (A1), **cuaderno de ejercicios**, unidad 5C | 26-27 | **solucionario oficial** (página 59 del propio cuaderno). El ej. 5 es de audio y texto de lectura (pista 6) y lleva su transcripción, tomada de la página 54-55, sobre la dieta mediterránea |
...
| `nuevo-espanol-en-marcha/a2/cuaderno-unidad1a_encantado.md` | Nuevo Español en Marcha 2 (A2), **cuaderno de ejercicios**, unidad 1A «¡Encantado!» | 8 | **solucionario oficial** (página 61 del propio cuaderno). Los ej. 1 y 4 son de tipo «relaciona» (tocar, no escribir la letra), con el primer ítem de cada uno ya resuelto como en el libro. Foto real de Nicole Manderson incrustada (ej. 3). Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a2/cuaderno-unidad1b_duermo-poco.md` | Nuevo Español en Marcha 2 (A2), **cuaderno de ejercicios**, unidad 1B «Duermo poco» | 9-10 | **solucionario oficial** (página 61 del propio cuaderno). El ej. 4 («La rutina de Lucía») es de audio (Pista 1); su transcripción se tomó de la página 58 («Transcripciones») y su mp3 real, de la carpeta de Drive «Audios cuaderno». Dos fotos reales incrustadas: Ángel Hervás en su puesto de control de tráfico aéreo (ej. 1) y Lucía (ej. 4) — ambas se habían pasado por alto en una primera pasada y se añadieron al detectarlo en una revisión posterior |
| `nuevo-espanol-en-marcha/a2/cuaderno-unidad1c_unas-vacaciones-inolvidables.md` | Nuevo Español en Marcha 2 (A2), **cuaderno de ejercicios**, unidad 1C «Unas vacaciones inolvidables» | 10-11 | **solucionario oficial** (página 61 del propio cuaderno). El ej. 3 («Escribe 10 frases sobre lo que hiciste el sábado pasado») es actividad libre, así que su caja de texto se envía al profesor sin corregir. Foto real de la Plaza de España de Barcelona incrustada (ej. 5, «La postal de Maribel») — también añadida en la misma revisión posterior. Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a2/cuaderno-unidad2a_quieres-ser-millonario.md` | Nuevo Español en Marcha 2 (A2), **cuaderno de ejercicios**, unidad 2A «¿Quieres ser millonario?» | 12 | **solucionario oficial** (página 62 del propio cuaderno). Fotos reales de Sevilla y Córdoba incrustadas (ej. 3). Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a2/cuaderno-unidad2b_biografias.md` | Nuevo Español en Marcha 2 (A2), **cuaderno de ejercicios**, unidad 2B «Biografías» | 13 | **solucionario oficial** (página 62 del propio cuaderno). Retrato real de Miguel de Cervantes incrustado (ej. 3). Sin ejercicios de audio |
| `nuevo-espanol-en-marcha/a2/cuaderno-unidad2c_ganadores.md` | Nuevo Español en Marcha 2 (A2), **cuaderno de ejercicios**, unidad 2C «Ganadores» | 14-15 | **solucionario oficial** (página 62 del propio cuaderno). El ej. 4 («Escribe una relación de las cosas que hiciste ayer») es actividad libre, así que su caja de texto se envía al profesor sin corregir. El ej. 1 es de audio (Pista 2, «Ganadores»); su transcripción se tomó de la página 58 («Transcripciones») y su mp3 real, de la carpeta de Drive «Audios cuaderno». Fotos reales de Gabriela Mistral, Pedro Almodóvar, Miguel Induráin y Camilo José Cela incrustadas |
| `nuevo-espanol-en-marcha/a2/cuaderno-unidad3a_la-boda-de-pili.md` | Nuevo Español en Marcha 2 (A2), **cuaderno de ejercicios**, unidad 3A «La boda de Pili» | 18-19 | **solucionario oficial** (página 62 del propio cuaderno). El ej. 4 («La boda de Pili y Carlos») es de audio (Pista 3); su transcripción se tomó de la página 58 («Transcripciones») y su mp3 real, de la carpeta de Drive «Audios cuaderno». Fotos reales del príncipe Felipe (ej. 1) y de la boda (ej. 4) incrustadas; sopa de letras real verificada por script (ej. 3, ocho relaciones familiares) |
| `nuevo-espanol-en-marcha/a2/cuaderno-unidad3b_como-te-ha-ido-hoy.md` | Nuevo Español en Marcha 2 (A2), **cuaderno de ejercicios**, unidad 3B «¿Cómo te ha ido hoy?» | 19-21 | **solucionario oficial** (páginas 62-63 del propio cuaderno). El ej. 3 («Forma frases») es actividad semilibre, así que no puntúa. Foto real de Rabí incrustada (ej. 5) y la tira cómica completa de Leo Verdura (ej. 6) |
| `nuevo-espanol-en-marcha/a2/cuaderno-unidad3c_costumbres.md` | Nuevo Español en Marcha 2 (A2), **cuaderno de ejercicios**, unidad 3C «Costumbres» | 21 | **solucionario oficial** (página 63 del propio cuaderno). Foto real del cartel de la piscina «Sol y Agua» incrustada (ej. 1). Sin ejercicios de audio |
...
| `nuevo-espanol-en-marcha/b1/cuaderno-unidad7a_un-buen-trabajo.md` | Nuevo Español en Marcha 3 (B1), **cuaderno de ejercicios**, unidad 7A | 28 | **solucionario oficial** (página 72 del propio cuaderno). El ej. 1 (relaciona profesiones) usa type "match". El ej. 3 (sopa de letras) usa type "wordsearch" interactivo con una rejilla propia, no un calco en píxeles del libro: el libro dice "diez profesiones" pero la clave de soluciones solo resalta nueve, verificadas letra a letra contra la imagen de la página 72 y por script en las 8 direcciones |
| `nuevo-espanol-en-marcha/b1/cuaderno-unidad7b_cuando-pueda-cambiare-de-trabajo.md` | Nuevo Español en Marcha 3 (B1), **cuaderno de ejercicios**, unidad 7B | 29 | **solucionario oficial** (página 72). El ej. 1 usa type "match". El ej. 2 mezcla subjuntivo/indicativo/presente según el sentido temporal de cada frase, tal cual lo da el propio solucionario (no deducido a mano) |
| `nuevo-espanol-en-marcha/b1/cuaderno-unidad7c_si-tuviera-dinero.md` | Nuevo Español en Marcha 3 (B1), **cuaderno de ejercicios**, unidad 7C | 30-31 | **solucionario oficial** (página 72). Los ej. 4 ("Lee el texto") y 5 ("Relaciona") del libro se fusionan en un único ejercicio interactivo (type "match" con el artículo en un refHTML), porque el ej. 4 del libro no tiene huecos propios. El ej. 6 del libro ("Contesta a las siguientes preguntas") es actividad libre según el propio solucionario ("Actividad libre"). El ej. 7 es de audio (pista 10) y lleva la grabación real (carpeta de Drive "Cuaderno.Audio", convertida de .wma a .mp3) más su transcripción completa (página 65) |
| `nuevo-espanol-en-marcha/b1/cuaderno-unidad8a_deportes.md` | Nuevo Español en Marcha 3 (B1), **cuaderno de ejercicios**, unidad 8A | 32 | **solucionario oficial** (página 72). El ej. 1 (sopa de letras de objetos deportivos) usa type "wordsearch" interactivo con una rejilla propia, verificada por script en las 8 direcciones; el libro combina "busca en la sopa" y "¿con qué deporte se relaciona?" en un solo enunciado, así que se separa en dos ejercicios (1 y 2) para poder puntuar ambas partes. El ej. 4 es de audio (pista 11, entrevista al ciclista Emilio Pedal) y lleva la grabación real más su transcripción completa (página 65-66) |
| `nuevo-espanol-en-marcha/b1/cuaderno-unidad8b_salimos.md` | Nuevo Español en Marcha 3 (B1), **cuaderno de ejercicios**, unidad 8B | 32-34 | **solucionario oficial** (página 72). El ej. 1 es de audio (pista 12, Isabel y Jesús) con su transcripción completa (página 65-66). Los ej. 2 y 3 (completar/escribir un diálogo) van como actividad libre: el libro da un modelo, pero la redacción es abierta (el ej. 3 lo marca el propio solucionario como "Actividad libre"). Los ej. 4-8 son las 5 baterías de transformación directo/indirecto del libro |
| `nuevo-espanol-en-marcha/b1/cuaderno-unidad8c_musica-arte-y-literatura.md` | Nuevo Español en Marcha 3 (B1), **cuaderno de ejercicios**, unidad 8C | 35 | **solucionario oficial** (página 72). El ej. 2 (relaciona pregunta-letra de la entrevista a Chema Madoz) escribe la letra en un hueco de texto en vez de type "match", porque las opciones son párrafos largos, no fichas cortas |
...
| `nuevo-espanol-en-marcha/b2/examen-unidades5-6.md` | Nuevo Español en Marcha 4 (B2), **Guía didáctica del profesor**, examen unidades 5-6 | 90-91 (examen), 98 (solucionario) | **solucionario oficial** de la guía. El ejercicio 7 (crucigrama) trae en el libro una rejilla ya dibujada, pero su lectura por píxeles no salió lo bastante fiable para reproducir las coordenadas exactas de sus cruces (mismo problema que en B1 5B) — se construyó una rejilla propia con las mismas 6 palabras y definiciones, con los cruces verificados por código en vez de a ojo; las respuestas del crucigrama van sin tilde ("meteorologo"), como es habitual en las casillas de estos rompecabezas |
