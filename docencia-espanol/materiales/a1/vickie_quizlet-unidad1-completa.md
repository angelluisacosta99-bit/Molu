...
= **tabulador**, separador entre tarjetas = **salto de línea**.
...
| Encantado / Encantada | Очень приятно (говорит мужчина / женщина) |
| Mucho gusto | Очень приятно (при знакомстве) |
| Igualmente | Взаимно |
| Adiós | До свидания |
...
## 2. Frases para la clase

| Español | Ruso |
|---|---|
| ¿Puede repetir, por favor? | Повторите, пожалуйста? |
| ¿Cómo se dice...? | Как сказать...? |
| ¿Cómo se escribe? | Как это пишется? |
| ¿Qué significa...? | Что значит...? |
| Perdone, no entiendo | Извините, я не понимаю |

## 3. Alfabeto y pronunciación

| Español | Ruso |
|---|---|
| el abecedario / el alfabeto | алфавит |
| deletrear | произносить слово по буквам |
| la mayúscula | заглавная буква |
| la minúscula | строчная буква |
| la tilde / el acento | знак ударения |
| la sílaba tónica | ударный слог |

## 4. Preguntas personales (tú / usted)

| Español | Ruso |
|---|---|
| ¿Cómo te llamas? / ¿Cómo se llama usted? | Как тебя / Вас зовут? |
| Me llamo... | Меня зовут... |
| ¿De dónde eres? / ¿De dónde es usted? | Откуда ты / Вы? |
| Soy de... | Я из... |
| ¿A qué te dedicas? / ¿A qué se dedica usted? | Кем ты работаешь / Вы работаете? |
| ¿Dónde vives? / ¿Dónde vive usted? | Где ты живёшь / Вы живёте? |
| ¿Cuál es tu número de teléfono? | Какой у тебя номер телефона? |
| ¿Cuál es tu correo electrónico? | Какой у тебя адрес электронной почты? |
| Este es... / Esta es... | Это... (представляя мужчину / женщину) |
| Le presento a... | Позвольте представить Вам... |
...
| dónde | где |
| cómo | как |
| cuál | какой (из вариантов) |
| quién / quiénes | кто |
| cuánto/a/os/as | сколько |

## 6. Fórmulas de tratamiento (tú / usted)

| Español | Ruso |
|---|---|
| tú | ты (неформальное обращение) |
| usted (Ud.) | Вы (формальное обращение, ед. ч.) |
| ustedes (Uds.) | вы (формальное обращение, мн. ч.) |
| el señor (Sr.) | господин |
| la señora (Sra.) | госпожа |
| el jefe / la jefa | начальник / начальница |
| desconocido/a | незнакомый человек |

## 7. Datos personales (ficha)

| Español | Ruso |
|---|---|
| el nombre | имя |
| el apellido / los apellidos | фамилия |
...
| taxista | таксист |
| cartero/cartera | почтальон |
| actor/actriz | актёр/актриса |
| abogado/abogada | адвокат |
| limpiador/limpiadora | уборщик/уборщица |
| vendedor/vendedora | продавец/продавщица |
| secretario/secretaria | секретарь |
| conductor/conductora | водитель |
| cocinero/cocinera | повар |
| futbolista | футболист |
| cantante | певец/певица |
| jardinero/jardinera | садовник |
| guía | гид |
| pianista | пианист |
| economista | экономист |
| presidente/presidenta | президент |
| estudiante | студент/студентка |
| informático/informática | специалист по информатике |
| enfermero/enfermera | медбрат/медсестра |
| arquitecto/arquitecta | архитектор |
| traductor/traductora | переводчик |
| pintor/pintora | художник |
| director/directora de cine | кинорежиссёр |

## 11. Verbos regulares en presente

| Español | Ruso |
|---|---|
| trabajar | работать (trabajo, trabajas, trabaja, trabajamos, trabajáis, trabajan) |
| comer | есть, кушать (como, comes, come, comemos, coméis, comen) |
| vivir | жить (vivo, vives, vive, vivimos, vivís, viven) |

## 12. Verbos irregulares clave
...
| doce (12) | двенадцать |
| trece (13) | тринадцать |
| catorce (14) | четырнадцать |
| quince (15) | пятнадцать |
| dieciséis (16) | шестнадцать |
| diecisiete (17) | семнадцать |
| dieciocho (18) | восемнадцать |
| diecinueve (19) | девятнадцать |
| veinte (20) | двадцать |

## 14. Operaciones simples
...
## Bloque para importar en Quizlet

Instrucciones: en Quizlet → *Crear* → *Importar*, pega todo el bloque de
abajo. Configura "entre término y definición" = **Tab** y "entre
tarjetas" = **Nueva línea** (suele detectarlo automáticamente).
