...
## Corpus Check
- 161 files · ~454,632 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2388 nodes · 5759 edges · 115 communities (101 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 121 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `437d46e9`
...
Cohesion: 0.04
Nodes (98): borderColorsFromStyle(), borderWidthsFromStyle(), checkBorders(), checkClippedOverflow(), checkColors(), checkCreamPalette(), checkElementAIPaletteDOM(), checkElementBorders() (+90 more)
...
Cohesion: 0.11
Nodes (28): detectUrl(), runVisualContrastFallback(), serializeDesignSystemForBrowser(), runRegexMatchers(), runTextContentAnalyzers(), collectStaticCssText(), detectHtml(), STATIC_ELEMENT_RULES (+20 more)
...
Cohesion: 0.09
Nodes (32): applyStaticDeclaration(), buildBorderOverrideMap(), parseShorthand(), buildStaticStyleMap(), buildStaticWindow(), collectStaticCssRules(), compareStaticPriority(), cssPropToCamel() (+24 more)
...
### Community 91 - "checkRepeatedSectionKickersFromDoc"
Cohesion: 0.33
...
## Knowledge Gaps
- **270 isolated node(s):** `mark-pr-reviewed.sh script`, `session-end-status.sh script`, `session-start.sh script`, `COMMON_DEV_PORTS`, `SCANNABLE_EXT` (+265 more)
...
- **Should `checks.mjs` be split into smaller, more focused modules?**
  _Cohesion score 0.044356435643564354 - nodes in this community are weakly interconnected._