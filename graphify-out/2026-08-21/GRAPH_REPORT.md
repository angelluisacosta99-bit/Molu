...
## Summary
- 2408 nodes · 5776 edges · 117 communities (104 shown, 13 thin omitted)
...
### Community 116 - "discoverTargetCandidates"
Cohesion: 0.43
...
## Knowledge Gaps
- **281 isolated node(s):** `mark-pr-reviewed.sh script`, `session-end-status.sh script`, `session-start.sh script`, `COMMON_DEV_PORTS`, `SCANNABLE_EXT` (+276 more)
