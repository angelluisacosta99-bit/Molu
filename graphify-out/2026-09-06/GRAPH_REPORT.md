...
## Corpus Check
- 260 files · ~1,310,135 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3134 nodes · 6446 edges · 212 communities (192 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 121 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `84d0a10e`
...
- **Why does `Docencia de español overview` connect `Docencia de español overview` to `Perfil de Avito: valoración, precios y descripción`, `Planificación overview`, `Molu — README del repositorio`?**
