...
## Corpus Check
- 261 files · ~1,314,168 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3148 nodes · 6456 edges · 216 communities (194 shown, 22 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 121 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9aa75a32`
...
Cohesion: 0.11
Nodes (39): acknowledgePendingEvent(), activeSessionSummaries(), agentPollingConnected(), annotRoot, args, broadcast(), broadcastAgentPollingIfChanged(), cancelQueuedAnonymousExitEvents() (+31 more)
...
### Community 29 - "createManualApplyController"
Cohesion: 0.15
...
Cohesion: 0.22
Nodes (15): getLiveDir(), args, buffer, cwd, pageUrlFilter, remaining, summarizePendingManualEditBatch(), getBufferPath() (+7 more)
...
Cohesion: 0.17
Nodes (17): getLiveSessionsDir(), completeCli(), completeThroughServer(), parseArgs(), readServerInfo(), applyEvent(), baseSnapshot(), COMPLETED_PHASES (+9 more)
...
Cohesion: 0.06
Nodes (34): 2026-08-16 — Guía oficial de buenas prácticas de Claude Code, 2026-08-16 — Primera pasada del radar, 2026-08-16 — Segunda pasada: hooks vs. CLAUDE.md, y prácticas de la comunidad, 2026-08-18 — MarkItDown (Microsoft): herramienta puntual, no instalada, 2026-08-18 — Práctica: desplazar la ventana de 5h de límite de uso, 2026-08-20 — agent-browser (Vercel Labs): activado, 2026-08-21 — find-skills (Vercel Labs): activado, 2026-08-21 — mcp-server-dev (Anthropic): activado, deshabilitado por defecto (+26 more)
...
Cohesion: 0.26
Nodes (12): isLiveServerPidReachable(), readLiveServerInfo(), collectManualApplyFiles(), manualApplyReplyCommand(), manualApplyResumeHint(), parseArgs(), resumeCli(), summarizeManualApplyEvent() (+4 more)
...
### Community 206 - "resolveCandidateContextSummary"
Cohesion: 0.33
...
### Community 211 - "browser-script-parts.mjs"
Cohesion: 0.33
...
### Community 214 - "createManualEditRoutes"
Cohesion: 0.60
...
## Knowledge Gaps
- **749 isolated node(s):** `caveman-mode.sh script`, `mark-pr-reviewed.sh script`, `session-end-status.sh script`, `session-start.sh script`, `COMMON_DEV_PORTS` (+744 more)
...
- **Why does `createManualApplyController()` connect `createManualApplyController` to `live-server.mjs`, `manual-apply.mjs`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `loadContext()` connect `live.mjs` to `context.mjs`, `cli`, `live-server.mjs`, `resolveContext`, `context-signals.mjs`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `readLiveServerInfo()` connect `readLiveServerInfo` to `live-poll.mjs`, `impeccable-paths.mjs`, `session-store.mjs`, `live-server.mjs`, `live.mjs`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
