...
## Corpus Check
- 269 files · ~1,339,493 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3227 nodes · 6530 edges · 221 communities (198 shown, 23 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 121 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a4893a5b`
...
## Knowledge Gaps
- **808 isolated node(s):** `caveman-mode.sh script`, `mark-pr-reviewed.sh script`, `session-end-status.sh script`, `session-start.sh script`, `sync-main.sh script` (+803 more)
