...
## Knowledge Gaps
- **878 isolated node(s):** `1. Situación de partida`, `2.1 Angel casi con seguridad es ИП на УСН «доходы», no самозанятый`, `2.2 Sin contrato de agencia, el impuesto se come el 30 % del margen`, `2.3 La salida legal: договор агентский (contrato de agencia)`, `2.4 La profesora debe darse de alta — y es trivial hacerlo` (+873 more)
...
- **What connects `1. Situación de partida`, `2.1 Angel casi con seguridad es ИП на УСН «доходы», no самозанятый`, `2.2 Sin contrato de agencia, el impuesto se come el 30 % del margen` to the rest of the system?**
