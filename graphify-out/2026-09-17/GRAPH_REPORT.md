...
### Community 41 - "normalizeWorkspacePattern"
Cohesion: 0.33
...
### Community 83 - "Bibliografía oficial — Máster Universitario en Sistemas Inteligentes (USAL)"
Cohesion: 0.11
Nodes (18): Analítica visual y visualización de la información, Asignaturas obligatorias (9), Bibliografía oficial — Máster Universitario en Sistemas Inteligentes (USAL), Cibermetría, Herramientas interactivas de simulación y control, Interacción Gestual, Minería de datos aplicada a la bioinformática, Minería Web (+10 more)
...
### Community 187 - "readWorkspacePatterns"
Cohesion: 0.24
Nodes (10): hasFallbackWorkspaceChildren(), isMonorepoRoot(), parseYamlFlowList(), readJson(), readLernaWorkspaces(), readPackageWorkspaces(), readPnpmWorkspaces(), readWorkspacePatterns() (+2 more)
...
### Community 199 - "Asignaturas optativas (elegir 6 de estas 10)"
Cohesion: 0.22
Nodes (9): Asignaturas optativas (elegir 6 de estas 10), Computación neuroborrosa, Control inteligente, Inteligencia ambiental y sistemas multiagente, Lógica para web semántica, Metodología de la investigación, Minería de datos, Nuevas tendencias en sistemas inteligentes (+1 more)
...
## Knowledge Gaps
- **907 isolated node(s):** `Start here`, `Specialized skills`, `Why agent-browser`, `Observability Dashboard`, `What it does` (+902 more)
