...
## Corpus Check
- 158 files · ~466,373 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2329 nodes · 5721 edges · 106 communities (97 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 135 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9913c9ab`
...
## Knowledge Gaps
- **237 isolated node(s):** `Ej. 1 — Mira el cuadro de Las meninas`, `Ej. 2 — Subraya la forma apropiada del verbo`, `Ej. 3 — Completa el texto sobre Pepa`, `Ej. 4 — Pon las palabras en el orden correcto`, `Ej. 5 — ¿Qué están haciendo?` (+232 more)
