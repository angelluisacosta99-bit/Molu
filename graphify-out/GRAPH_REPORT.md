...
## Corpus Check
- 158 files · ~449,227 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2348 nodes · 5739 edges · 106 communities (97 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 135 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `80c0b7dc`
...
### Community 25 - "live-copy-edit-agent.mjs"
Cohesion: 0.14
...
### Community 29 - "Novedades de herramientas de IA"
Cohesion: 0.11
Nodes (17): 2026-08-16 — Guía oficial de buenas prácticas de Claude Code, 2026-08-16 — Primera pasada del radar, 2026-08-16 — Segunda pasada: hooks vs. CLAUDE.md, y prácticas de la comunidad, 2026-09-07 — Búsqueda a mano: herramientas para posts de blog en plataformas de clases, 2026-09-09 — Skill "humanizer" (terceros, adaptada a mano), Anotado, no aplicado: hooks para reglas duras, no solo CLAUDE.md, Anotado, no aplicado: patrones de `awattar/claude-code-best-practices`, Aplicado: hook `Stop` con estado de git ("radical transparency") (+9 more)
...
### Community 52 - "syncEditBadgeHitProxies"
Cohesion: 0.27
...
## Knowledge Gaps
- **253 isolated node(s):** `1. Un temario probado, no clases improvisadas`, `2. Cada alumno tiene su propio plan`, `3. Practicar de verdad, con corrección instantánea`, `4. Vocabulario que se queda, no que se olvida`, `Por qué me lo tomo así` (+248 more)
