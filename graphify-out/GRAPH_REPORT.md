...
## Corpus Check
- 157 files · ~446,572 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2320 nodes · 5713 edges · 106 communities (97 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 135 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b103c4ad`
...
### Community 68 - "Becas y trámites — MUSI, curso 2026/2027"
Cohesion: 0.33
...
## Knowledge Gaps
- **232 isolated node(s):** `1. BOE — RD 1721/2007, art. 4.1.d) — **sin verificar**`, `2. Convocatorias vigentes en `becas.usal.es` (curso 2026/2027)`, `3. BISITE (`bisite.usal.es`)`, `4. Salidas laborales / prácticas`, `HEADING_TAGS` (+227 more)
...
- **What connects `1. BOE — RD 1721/2007, art. 4.1.d) — **sin verificar**`, `2. Convocatorias vigentes en `becas.usal.es` (curso 2026/2027)`, `3. BISITE (`bisite.usal.es`)` to the rest of the system?**
