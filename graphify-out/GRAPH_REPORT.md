...
## Corpus Check
- 157 files · ~450,341 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 6 file(s) not represented in the graph (top: (none) 3, .pptx 3)

## Summary
- 2407 nodes · 5930 edges · 114 communities (104 shown, 10 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 132 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ab81cd6`
...
Cohesion: 0.05
Nodes (87): allEntryIds(), argVal(), buildRepairBatch(), candidatesForEntry(), changedFilesSinceSnapshot(), clearAppliedEntries(), collectApplyOwnedFiles(), collectRollbackFiles() (+79 more)
...
Cohesion: 0.07
Nodes (58): cursorBlockMessage(), ACK_EXTS, bumpEditCount(), clampByte(), clampGroupedToBudget(), clampToBudget(), CO_SCAN_STYLE_NAMES, coLocatedStylesheets() (+50 more)
...
Cohesion: 0.11
Nodes (36): bumpCursorDenial(), escapeRegExp(), findingSignature(), firstMatch(), firstString(), hasFragmentEditContent(), isInsideProject(), main() (+28 more)
...
### Community 25 - "createManualApplyController"
Cohesion: 0.15
...
### Community 34 - "writeAuditLog"
Cohesion: 0.39
Nodes (7): allow(), deny(), done(), writeAuditLog(), main(), readStdin(), Anotado, no aplicado: patrones de `awattar/claude-code-best-practices`
...
### Community 68 - "2026-08-16 — Primera pasada del radar"
Cohesion: 0.17
Nodes (11): 2026-08-16 — Guía oficial de buenas prácticas de Claude Code, 2026-08-16 — Primera pasada del radar, 2026-08-16 — Segunda pasada: hooks vs. CLAUDE.md, y prácticas de la comunidad, Anotado, no aplicado: hooks para reglas duras, no solo CLAUDE.md, Aplicado: hook `Stop` con estado de git ("radical transparency"), Brisk Teaching (conector MCP), Cómo se usa, DeepL (conector MCP) (+3 more)
...
### Community 81 - "Planificación overview"
Cohesion: 0.20
...
### Community 83 - "Asignaturas optativas (elegir 6 de estas 10)"
Cohesion: 0.18
Nodes (11): Asignaturas optativas (elegir 6 de estas 10), Cibermetría, Herramientas Interactivas de Simulación y Control, Ingeniería Web y Web Semántica, Interacción Gestual, Minería de Datos Aplicada a la Bioinformática, Minería Web, Navegación de Robots (+3 more)
...
### Community 85 - "Asignaturas obligatorias (9)"
Cohesion: 0.20
Nodes (10): Analítica Visual y Visualización de Información, Asignaturas obligatorias (9), Computación Neuroborrosa, Control Inteligente, Inteligencia Ambiental y Sistemas Multiagente, Lógica para la Web Semántica, Metodología de Investigación, Minería de Datos (+2 more)
...
### Community 91 - "normalizeGitHubEvent"
Cohesion: 0.38
...
### Community 92 - "readLiveServerInfo"
Cohesion: 0.48
...
### Community 94 - "browser-script-parts.mjs"
Cohesion: 0.33
...
### Community 108 - "acceptedDomAlreadyClean"
Cohesion: 0.53
...
### Community 109 - "Docencia de español overview"
Cohesion: 0.33
...
### Community 110 - "enableInlineEdit"
Cohesion: 0.40
Nodes (5): collectEditableTextRows(), visit(), enableInlineEdit(), onInlineInput(), wrapMixedContentTextNodes()

### Community 111 - "Bibliografía oficial — Máster Universitario en Sistemas Inteligentes (USAL)"
Cohesion: 0.50
Nodes (3): Bibliografía oficial — Máster Universitario en Sistemas Inteligentes (USAL), Trabajo de Fin de Máster, Trabajo de Fin de Máster + Workshop

## Knowledge Gaps
- **272 isolated node(s):** `session-end-status.sh script`, `session-start.sh script`, `COMMON_DEV_PORTS`, `SCANNABLE_EXT`, `SOURCE_DIRS` (+267 more)
...
- **Why does `Anotado, no aplicado: patrones de `awattar/claude-code-best-practices`` connect `writeAuditLog` to `2026-08-16 — Primera pasada del radar`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **What connects `session-end-status.sh script`, `session-start.sh script`, `COMMON_DEV_PORTS` to the rest of the system?**
