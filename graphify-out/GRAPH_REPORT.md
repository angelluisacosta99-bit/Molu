...
## Corpus Check
- 157 files · ~447,281 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2326 nodes · 5719 edges · 104 communities (95 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 135 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e54e3cff`
...
- Becas y ayudas para el Máster en Sistemas Inteligentes (USAL)
- design-parser.mjs
...
### Community 25 - "Becas y ayudas para el Máster en Sistemas Inteligentes (USAL)"
Cohesion: 0.17
Nodes (11): Becas de Colaboración en Departamentos Universitarios (Ministerio, curso 2026/2027), Becas Internacionales de Máster de la USAL (para tu máster concreto), Becas propias USAL (matrícula + 1.000 € de alojamiento), Becas y ayudas para el Máster en Sistemas Inteligentes (USAL), Fundación Carolina (convocatoria 2026-2027), 🟢 Ingresos paralelos (no son becas, pero cubren el mismo hueco), ⚪ No aplican en tu situación (para que sepas por qué las descarto), Pistas sin verificar a fondo (raíces de bajo esfuerzo, alto valor si dan fruto) (+3 more)
...
## Knowledge Gaps
- **236 isolated node(s):** `Becas de Colaboración en Departamentos Universitarios (Ministerio, curso 2026/2027)`, `Fundación Carolina (convocatoria 2026-2027)`, `Becas Internacionales de Máster de la USAL (para tu máster concreto)`, `Becas propias USAL (matrícula + 1.000 € de alojamiento)`, `⚪ No aplican en tu situación (para que sepas por qué las descarto)` (+231 more)
...
- **What connects `Becas de Colaboración en Departamentos Universitarios (Ministerio, curso 2026/2027)`, `Fundación Carolina (convocatoria 2026-2027)`, `Becas Internacionales de Máster de la USAL (para tu máster concreto)` to the rest of the system?**
...
- **Should `checks.mjs` be split into smaller, more focused modules?**
  _Cohesion score 0.04514363885088919 - nodes in this community are weakly interconnected._