...
- **compileShader()** (4 connections) — `.claude/skills/impeccable/scripts/live-browser.js`
...
- **shouldUseAncestorCropShaderProxy()** (2 connections) — `.claude/skills/impeccable/scripts/live-browser.js`
- **showShaderBitmapFallback()** (2 connections) — `.claude/skills/impeccable/scripts/live-browser.js`
- **frame()** (1 connections) — `.claude/skills/impeccable/scripts/live-browser.js`
