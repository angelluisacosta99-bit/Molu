...
- **isGeneratedFile()** (16 connections) — `.claude/skills/impeccable/scripts/lib/is-generated.mjs`
- **is-generated.mjs** (12 connections) — `.claude/skills/impeccable/scripts/lib/is-generated.mjs`
- **searchDir()** (5 connections) — `.claude/skills/impeccable/scripts/live-wrap.mjs`
- **hasGeneratedHeader()** (2 connections) — `.claude/skills/impeccable/scripts/lib/is-generated.mjs`
- **isGitIgnored()** (2 connections) — `.claude/skills/impeccable/scripts/lib/is-generated.mjs`
- **HEADER_MARKERS** (1 connections) — `.claude/skills/impeccable/scripts/lib/is-generated.mjs`
