...
- **manual-apply.mjs** (53 connections) — `.claude/skills/impeccable/scripts/live/manual-apply.mjs`
...
- **countManualApplyOps()** (5 connections) — `.claude/skills/impeccable/scripts/live/manual-apply.mjs`
- **manualApplyEvidenceDir()** (5 connections) — `.claude/skills/impeccable/scripts/live/manual-apply.mjs`
- **manualApplyTransactionPath()** (5 connections) — `.claude/skills/impeccable/scripts/live/manual-apply.mjs`
- **readManualApplyTransaction()** (5 connections) — `.claude/skills/impeccable/scripts/live/manual-apply.mjs`
- **buildManualApplyAgentAction()** (4 connections) — `.claude/skills/impeccable/scripts/live/manual-apply.mjs`
- **compactManualApplyBatch()** (4 connections) — `.claude/skills/impeccable/scripts/live/manual-apply.mjs`
- **compactManualApplyCandidates()** (4 connections) — `.claude/skills/impeccable/scripts/live/manual-apply.mjs`
- **compactManualApplyContext()** (4 connections) — `.claude/skills/impeccable/scripts/live/manual-apply.mjs`
- **compactManualApplyEntry()** (4 connections) — `.claude/skills/impeccable/scripts/live/manual-apply.mjs`
- **compactManualApplyOp()** (4 connections) — `.claude/skills/impeccable/scripts/live/manual-apply.mjs`
